...
class TestExecute:
    ...
    def test_serialize_circuit_rotations_tape(self, monkeypatch, tmpdir, test_result):
        """Test that a circuit that is serialized correctly with rotations for
    ...
    def test_serialize_circuit_no_rotations_tape(self, monkeypatch, tmpdir, test_result):
        """Test that a circuit that is serialized correctly without rotations for
